                                    ...
                                    <?php if($_SERVER['REQUEST_METHOD'] == 'POST'): ?>
                                        ...
                                        <div class="mb-3">
                                            <dl>
                                                ...
                                                <dt class="fw-light text-body">Using sha1()</dt>
                                                <dd><?= sha1($_POST['password']) ?></dd>
                                                <dt class="fw-light text-body">Using password_hash()</dt>
                                                <dd><?= password_hash($_POST['password'], PASSWORD_DEFAULT) ?></dd>
                                                <dt class="fw-light text-body">Using hash()</dt>
                                                <dd><?= hash('sha256', $_POST['password']) ?></dd>
                                            </dl>
                                        </div>
                                    <?php endif; ?>
                                </form>
